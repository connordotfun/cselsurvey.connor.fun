...
var author$project$Main$NewSentencesGenerated = function (a) {
	return {$: 'NewSentencesGenerated', a: a};
};
...
var author$project$Main$decodeSentences = A2(
...
var author$project$Main$getGeneratorUrl = A3(
	elm$url$Url$Builder$crossOrigin,
	'https://d48oi7sm4b.execute-api.us-east-1.amazonaws.com',
	_List_fromArray(
		['default', 'csel-survey-generator']),
	_List_Nil);
...
var author$project$Main$getNewSentences = A2(
	elm$http$Http$send,
	author$project$Main$NewSentencesGenerated,
	A2(elm$http$Http$get, author$project$Main$getGeneratorUrl, author$project$Main$decodeSentences));
...
var author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'GetNewSentence') {
			return author$project$Main$getNextSentence(model);
		} else {
			var newData = msg.a;
			return _Utils_Tuple2(
				author$project$Main$handleModelUpdate(newData),
				elm$core$Platform$Cmd$none);
		}
	});
var author$project$Main$GetNewSentence = {$: 'GetNewSentence'};
...
var author$project$Main$getSentenceToRender = function (model) {
	var _n0 = elm$core$List$head(model);
	if (_n0.$ === 'Just') {
		var s = _n0.a;
		return s;
	} else {
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('What do students think about CSEL?')
							])),
						elm$html$Html$text(
						author$project$Main$getSentenceToRender(model))
					])),
				A2(
				elm$html$Html$button,
				_List_fromArray(
					[
						elm$html$Html$Attributes$id('button'),
						elm$html$Html$Events$onClick(author$project$Main$GetNewSentence)
					]),
				_List_fromArray(
					[
